...
//     console.log("there are " + officeItems.length + " computers")
// break
// }
...
for(var i = 0; i < peopleWhoWantToSeeMadMaxFuryRoad.length; i++) {
    if (peopleWhoWantToSeeMadMaxFuryRoad[i].age >= 18 || peopleWhoWantToSeeMadMaxFuryRoad[i].gender === "female") { 
        console.log(peopleWhoWantToSeeMadMaxFuryRoad[i].name + " is old enough to see Mad Max. She is good to see it.")
    } else {
